...
POS
	...
	<script src="<?php echo base_url('assets/bootstrap/js/simpleCart.min.js')?>"></script>
          ...
          <ul class="dropdown-menu dropdown-cart" role="menu">
            ...
            <li>
                <span class="item message1">
                    ...
                    <span class="item-right">
                        <button class="btn btn-xs btn-danger pull-right alert-close1">x</button>
                    </span>
                </span>
            </li>
            <li>
